...
void CGameFramework::BuildObjects()
{
	...
	CSkinMeshDiffused *pSkinMesh = new CSkinMeshDiffused(m_pd3dDevice, 10.0f, 12.0f, 10.0f, MARINE_TXT);
	...
	//	pPlayerShader->CreateShader(m_pd3dDevice, NULL, 0, L"Effect.fx", "VSTexturedMarineColor", "vs_5_0", "PSTexturedMarineColor", "ps_5_0");
