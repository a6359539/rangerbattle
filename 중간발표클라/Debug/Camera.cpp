...
{
	D3DXMatrixPerspectiveFovLH(&m_d3dxmtxProjection, (float)D3DXToRadian(fFOVAngle), fAspectRatio, fNearPlaneDistance,5000.f);
}
...
void CThirdPersonCamera::Update(D3DXVECTOR3& d3dxvLookAt, float fTimeElapsed)
{
	if (m_pPlayer)
	{
		...
		mtxRotate._11 = d3dxvRight.x; mtxRotate._21 = d3dxvUp.x;
		...
		mtxRotate._23 = d3dxvUp.z; mtxRotate._33 = d3dxvLook.z;
	...
	//	if (fDistance > fLength) fDistance = fLength;
		...
		//{
			...
			CThirdPersonCamera::Rotate(sumrotate, 0, 0);
	//	}
	}
}
